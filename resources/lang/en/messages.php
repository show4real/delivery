<?php return array (
  ...
  'no_products_on_pos_search' => 'To get the required search result First select module & then store to search category wise products or search manually to find products under that store.',
